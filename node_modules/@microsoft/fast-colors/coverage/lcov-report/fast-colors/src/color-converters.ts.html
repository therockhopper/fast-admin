...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">fast-colors/src</a> color-converters.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">97.87% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>230/235</span>
            </div>
...
<a name='L555'></a><a href='#L555'>555</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
 ...
 * @public
 */
export function <span class="fstat-no" title="function not covered" >calculateOverlayColor(</span>
    rgbMatch: ColorRGBA64,
    rgbBackground: ColorRGBA64,
    rgbOverlay: ColorRGBA64
): ColorRGBA64 {
    const rChannel: number =
<span class="cstat-no" title="statement not covered" >        (rgbMatch.r - rgbBackground.r) / (rgbOverlay.r - rgbBackground.r);</span>
    const gChannel: number =
<span class="cstat-no" title="statement not covered" >        (rgbMatch.g - rgbBackground.g) / (rgbOverlay.g - rgbBackground.g);</span>
    const bChannel: number =
<span class="cstat-no" title="statement not covered" >        (rgbMatch.b - rgbBackground.b) / (rgbOverlay.b - rgbBackground.b);</span>
    const alpha: number = <span class="cstat-no" title="statement not covered" >(rChannel + gChannel + bChannel) / 3;</span>
<span class="cstat-no" title="statement not covered" >    return new ColorRGBA64(rgbOverlay.r, rgbOverlay.g, rgbOverlay.b, alpha);</span>
}
&nbsp;
/**
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Jun 30 2020 16:25:05 GMT-0700 (Pacific Daylight Time)
            </div>
        </div>
