...
import { Direction, keyCodeArrowDown, keyCodeArrowLeft, keyCodeArrowRight, keyCodeArrowUp, keyCodeEnd, keyCodeHome, keyCodeTab, Orientation, } from "@microsoft/fast-web-utilities";
 ...
 * @public
 */
export class Slider extends FormAssociated {
    constructor() {
        super(...arguments);
        /**
         * @internal
        ...
        this.setupDefaultValue = () => {
            if (this.value === "") {
                this.initialValue = `${this.convertToConstrainedValue((this.max + this.min) / 2)}`;
            }
        };
        /**
