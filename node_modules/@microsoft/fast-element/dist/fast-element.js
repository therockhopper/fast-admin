...
class FASTElementDefinition {
  ...
  constructor(type, nameOrConfig = type.definition) {
    ...
    this.styles = nameOrConfig.styles !== void 0 && !(nameOrConfig.styles instanceof ElementStyles) ? css` ${nameOrConfig.styles} ` : nameOrConfig.styles;
  }
  /**
...
export { AttachedBehaviorDirective, AttributeDefinition, BindingBehavior, BindingDirective, ChildrenBehavior, Controller, DOM, Directive, ElementStyles, ExecutionContext, FASTElement, FASTElementDefinition, HTMLView, Observable, PropertyChangeNotifier, RefBehavior, RepeatBehavior, RepeatDirective, SlottedBehavior, SubscriberSet, ViewTemplate, attr, booleanConverter, children, compileTemplate, css, customElement, defaultExecutionContext, elements, emptyArray, html, nullableNumberConverter, observable, ref, repeat, setCurrentEvent, slotted, volatile, when };
