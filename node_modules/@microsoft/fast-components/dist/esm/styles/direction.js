 ...
 * ```
 */
export const inlineStartBehavior = cssCustomPropertyBehaviorFactory("inline-start", (designSystem) => direction(designSystem) === Direction.ltr ? "left" : "right", FASTDesignSystemProvider.findProvider);
/**
 ...
 * ```
 */
export const inlineEndBehavior = cssCustomPropertyBehaviorFactory("inline-end", (designSystem) => direction(designSystem) === Direction.ltr ? "right" : "left", FASTDesignSystemProvider.findProvider);
