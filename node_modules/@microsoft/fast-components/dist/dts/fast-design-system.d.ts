...
export declare type DesignSystemResolver<T, Y = FASTDesignSystem> = (d: Y) => T;
/**
 ...
 */
export declare function evaluateDesignSystemResolver<T>(arg: T | DesignSystemResolver<T>, designSystem: FASTDesignSystem): T;
/**
 * Safely retrieves the value from a key of the DesignSystem.
 */
export declare function getDesignSystemValue<T extends FASTDesignSystem, K extends keyof T>(key: K): (designSystem?: T) => T[K];
/**
