 ...
 * @deprecated
 */
export declare function isLightMode(designSystem: FASTDesignSystem): boolean;
/**
 ...
 * @internal
 */
export declare function swatchByContrast(referenceColor: string | SwatchResolver): (paletteResolver: Palette | DesignSystemResolver<Palette>) => (indexResolver: (referenceColor: string, palette: Palette, designSystem: FASTDesignSystem) => number) => (directionResolver: (referenceIndex: number, palette: Palette, designSystem: FASTDesignSystem) => 1 | -1) => (contrastCondition: (contrastRatio: number) => boolean) => DesignSystemResolver<Swatch>;
/**
 * Resolves the index that the contrast search algorithm should start at
 * @internal
 */
export declare function referenceColorInitialIndexResolver(referenceColor: string, sourcePalette: Palette, designSystem: FASTDesignSystem): number;
/**
 * @internal
 */
export declare function findClosestBackgroundIndex(designSystem: FASTDesignSystem): number;
/**
 * @internal
 */
